...
//             const nomPrise = data.slice(0,8);
//             setnomPrise(nomPrise);
//             console.log("nom de la prise : ",nomPrise);


//             const extracted = data.slice(19, 47); // Slice de l'indice 19 à l'indice 46 inclus
//             setExtractedData(extracted);

//             console.log("L'id de la prise scanné : ",extracted);
            
//         }
   
//     };

//     //extractedData présente les données affichées dans l'alert après le scan du qr code, avec ces données on recupére juste l'id de la prise
//     let id_prise = extractedData;
